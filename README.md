...
## Author
[Uziel Beltran] - COSC 2436, [Spring 2026]

## Description
This portfolio contains programming labs completed throughout the semester for
COSC 2436: Programming Fundamentals III. The projects explore a variety of
algorithms and data structures including searching, sorting, recursion, graph
algorithms, trees, dynamic programming, and introductory machine learning
concepts. The goal of this portfolio is to demonstrate both practical coding
skills and an understanding of algorithm efficiency and problem-solving
strategies.
